...
import { addUser, forgotPassword, generateToken, getUser, getUserByID, resetPassword } from "../Controller/users.js";
...
router.post("/forgot-password", async(req, res) => {
    try {
        ...
        const link = `https://resilient-puppy-b7932d.netlify.app/authorize/${user._id}~${token}`;
        const mailOptions = {
